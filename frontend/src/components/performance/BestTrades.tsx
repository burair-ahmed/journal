...
export const BestTrades = ({ trades }: BestTradesProps) => {
  ...
  return (
    <Card className="p-6 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-xl font-semibold">Top 10 Winning Trades</h3>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 flex-1">
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-profit/10 text-profit font-bold text-sm">
                  {index + 1}
                </div>
              ...
              <div className="flex items-center gap-2">
                <Badge className="bg-profit/10 text-profit border-profit/20 hover:bg-profit/20 text-base font-bold px-3 py-1">
